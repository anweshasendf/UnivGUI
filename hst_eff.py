...
def plot_contours(temp_df):
    ...
    for (unit, angle), df_filtered in grouped:
        ...
        plt.savefig(r"plot_"+unit+"_"+angle+".png")

def main():
    input_directory = r"C:\Users\U436445\Downloads\hsteff\data\Unit 1"
    all_df = hst_efficiency_calculate(input_directory)
    all_df.to_csv(r"results.csv")
    plot_contours(all_df)
