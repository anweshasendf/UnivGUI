...
def create_pdf_report(data, images, output_path, logo_path, single_file_plots=None, single_file_name=None, efficiency_comparison=None):
    ...
    #     pdf_gen.elements.append(Paragraph("Anomalies", pdf_gen.styles['Heading1']))
    #     pdf_gen.add_table(data["Anomalies"], "Anomalies")
    #     anomalies_table = Table(data["Anomalies"].values.tolist(), colWidths=[120, 250, 100])
    ...
    #         ('GRID', (0, 0), (-1, -1), 1, colors.black)
    #     ]))
    #     pdf_gen.elements.append(anomalies_table)
